    ...
    public partial class modificarAutomovil : Form
    {
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                new SqlAutomoviles().actualizarAutomovil(new Automovil(-1, this.textBoxPatente.Text, this.comboBoxMarca.Text, this.textBoxModelo.Text, Int32.Parse(this.textBoxChofer.Text), this.auto.turnos, this.textBoxLicencia.Text, this.textBoxRodado.Text, this.comboBoxEstado.Text), this.auto.id);
                new buscadorAutomovil().Show();
                this.Close();
            }
